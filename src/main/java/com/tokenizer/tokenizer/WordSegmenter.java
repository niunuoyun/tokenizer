...
import com.tokenizer.tokenizer.recognition.StopWord;
import com.tokenizer.tokenizer.segmentation.SegmentationAlgorithm;
import com.tokenizer.tokenizer.segmentation.SegmentationFactory;
import com.tokenizer.tokenizer.segmentation.Word;
import com.tokenizer.tokenizer.util.Utils;
...
public class WordSegmenter {
    ...
    private static void demo(){
        ...
        sentences.add("huihua.niu是APDPlat应用级产品开发平台的作者");
        ...
        sentences.add("word是一个中文分词项目，作者是huihua.niu，huihua.niu的英文名叫ysc");
    ...
    private static void showUsage(){
        ...
        LOGGER.info("demo");
        LOGGER.info("text huihua.niu是APDPlat应用级产品开发平台的作者");
