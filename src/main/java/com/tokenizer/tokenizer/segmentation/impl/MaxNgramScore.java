...
package com.tokenizer.tokenizer.segmentation.impl;

import com.tokenizer.tokenizer.corpus.Bigram;
import com.tokenizer.tokenizer.recognition.RecognitionTool;
...
public class MaxNgramScore extends AbstractSegmentation {
   ...
   /*     if(args !=null && args.length > 0){
        ...
        System.out.println(segmentation.seg("《红楼梦》的作者是曹雪芹。课文里有一篇鲁迅的《从百草园到三味书屋》。他的文章在《人民日报》上发表了。桌上放着一本《中国语文》。《〈中国工人〉发刊词》发表于1940年2月7日。huihua.niu是APDPlat应用级产品开发平台的作者"));
     //   System.out.println(segmentation.seg("我爱huihua.niu"));
    }
}