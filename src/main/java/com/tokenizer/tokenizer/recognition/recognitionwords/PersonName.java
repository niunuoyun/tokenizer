...
package com.tokenizer.tokenizer.recognition.recognitionwords;

import com.tokenizer.tokenizer.segmentation.PartOfSpeech;
import com.tokenizer.tokenizer.segmentation.Word;
import com.tokenizer.tokenizer.tagging.PartOfSpeechTagging;
...
public class PersonName {
    ...
    public static void main(String[] args){
        ...
        LOGGER.info("huihua.niu："+is("huihua.niu"));
        LOGGER.info("欧阳飞燕："+is("欧阳飞燕"));
        LOGGER.info("令狐冲："+is("令狐冲"));
        LOGGER.info("huihua.niu爱读书："+is("huihua.niu爱读书"));
