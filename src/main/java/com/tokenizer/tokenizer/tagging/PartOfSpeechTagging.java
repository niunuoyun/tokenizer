...
package com.tokenizer.tokenizer.tagging;
...
import com.tokenizer.tokenizer.util.GenericTrie;
...
public class PartOfSpeechTagging {
    ...
    public static void main(String[] args) {
        List<Word> words = WordSegmenter.segWithStopWords("我爱中国，我爱huihua.niu");
