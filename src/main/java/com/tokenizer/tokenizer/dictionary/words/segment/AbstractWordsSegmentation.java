 ...
 * @author huihua.niu
 */
public abstract class AbstractWordsSegmentation implements DictionaryWordsBasedSegmentation {
   ...
   // private static Dictionary dictionary = DictionaryFactory.getDictionary();
    ...
    public static void main(String[] args){
        Segmentation englishSegmentation = new AbstractWordsSegmentation() {
            @Override
