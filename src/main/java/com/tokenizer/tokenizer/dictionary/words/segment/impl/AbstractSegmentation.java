...
package com.tokenizer.tokenizer.dictionary.words.segment.impl;

import com.tokenizer.tokenizer.corpus.Bigram;
import com.tokenizer.tokenizer.corpus.Trigram;
import com.tokenizer.tokenizer.dictionary.Dictionary;
import com.tokenizer.tokenizer.dictionary.DictionaryFactory;
import com.tokenizer.tokenizer.dictionary.words.DictionaryWordsFactory;
import com.tokenizer.tokenizer.dictionary.words.WordsDictionary;
import com.tokenizer.tokenizer.dictionary.words.segment.DictionaryWordsBasedSegmentation;
import com.tokenizer.tokenizer.recognition.PersonName;
import com.tokenizer.tokenizer.recognition.Punctuation;
import com.tokenizer.tokenizer.segmentation.*;
 ...
 * @author huihua.niu
 */
public abstract class AbstractSegmentation  implements DictionaryWordsBasedSegmentation {
    ...
    //允许动态更改词典操作接口实现
    private static WordsDictionary dictionary = DictionaryWordsFactory.getDictionary();
